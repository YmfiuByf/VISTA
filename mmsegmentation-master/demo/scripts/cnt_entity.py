...
if __name__ == '__main__':
    ...
    num = 1000
    if os.path.exists(r"D:\pycharmProject\paper\task2\result2.csv"):
        df = pd.read_csv(r"D:\pycharmProject\paper\task2\result2.csv").iloc[:,1:]
    else:
    ...
    for i in range(1000):
        ...
        try:
            ...
            continue
        button2 = driver2.find_element('xpath',
                                       '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]/div[1]/div[2]/div/div[1]/div/div[4]/div/button/div/p')
        browser = driver2.find_element('xpath',
                                       '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]/div[1]/div[2]/div/div[1]/div/div[5]/div[1]/div/div[1]/div/section/button')
        ...
        # sim,cnt = 1.0, 4
        # need_reload = True
        # while need_reload and cnt>0:
        #     driver2.find_element('xpath',
        #                          '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]/div[1]/div[2]/div/div[1]/div/div[5]/div[1]/div/div[1]/div/section/input').send_keys(
        #         upload_path)
        #     print('uploading')
        #     time.sleep(10)
        #     driver2.find_element('xpath',
        #                          '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]/div[1]/div[2]/div/div[1]/div/div[5]/div[1]/div/div[2]/div/div/button/div/p').click()
        #     print('uploaded')
        #     time.sleep(7)
        #     try:
        ...
        while text2_not_ready:
            try:
                driver2.find_element('xpath','//*[@id="root"]/div[1]/div[1]/div/div/div/section[2]/div[1]/div[1]/div/div[8]/div/div/div')
            except NoSuchElementException:
            ...
            # if 'Predicted' in text2: assert NoSuchElementException
        # except NoSuchElementException:
        #     print('problem with uploading')
        #     driver.refresh()
        #     driver2.refresh()
        ...
        df.to_csv(r"D:\pycharmProject\paper\task2\result2.csv")
        while flag:
            try:
                iframe = driver.find_element('xpath', '//*[@id="iFrameResizer0"]')
                iframe2 = driver2.find_element('xpath', '//*[@id="iFrameResizer0"]')
                ...
                iframe2 = driver2.find_element('xpath', '//*[@id="iFrameResizer0"]')
        flag = True
        # iframe, iframe2 = refresh(driver,driver2)
        driver.switch_to.frame(iframe)
        driver2.switch_to.frame(iframe2)
        time.sleep(5)
