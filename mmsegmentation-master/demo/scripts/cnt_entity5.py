...
if __name__ == '__main__':
    ...
    num = 1000
    if os.path.exists(r"D:\pycharmProject\paper\task2\result5.csv"):
        df = pd.read_csv(r"D:\pycharmProject\paper\task2\result5.csv").iloc[:,1:]
    else:
    ...
    for i in range(1000):
        ...
        print('generating')
        key_problem = ele_disappear(driver,bar_xpath,'//*[@id="gallery"]/div[1]/div/div[2]')
        if key_problem:
            refresh()
        ...
        df.to_csv(r"D:\pycharmProject\paper\task2\result5.csv")
