...
if __name__ == '__main__':
    ...
    num = 1000
    if os.path.exists(r"D:\pycharmProject\paper\task2\result3.csv"):
        df = pd.read_csv(r"D:\pycharmProject\paper\task2\result3.csv").iloc[:,1:]
    else:
    ...
    for i in range(1000):
        ...
        df.to_csv(r"D:\pycharmProject\paper\task2\result3.csv")
