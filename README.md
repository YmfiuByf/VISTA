...
**VISTA** (**Vi**deo Transmission over A **S**emantic Communication Approach) is a semantic video transmission framework for wireless environments. Instead of transmitting full pixel-level video frames, VISTA transmits semantic information to reduce bandwidth consumption while maintaining reconstruction quality.
...
Traditional wireless video transmission usually sends pixel-level information directly, which requires high bandwidth and processing cost. VISTA addresses this problem by separating video content into semantic parts and transmitting only the most necessary information.
...
<p align="center">
  <img src="results/Fig1.png" alt="VISTA transceiver diagram" width="95%">
</p>
<p align="center"><em>Figure 1. The transceiver design of VISTA.</em></p>
...
In the first step of the process, frames to be transmitted are segmented into static objects and moving objects. **MMSegmentation** is used here for this purpose.
...
<p align="center">
  <img src="results/Fig2.png" alt="PSNR performance under different SNRs" width="75%">
</p>
<p align="center"><em>Figure 2. PSNR performance of recovered video frames versus varying SNRs.</em></p>
...
<p align="center">
  <img src="results/Fig3.png" alt="Visual comparison on a VIRAT frame" width="95%">
</p>
<p align="center"><em>Figure 3. Visual comparison on a video frame sample from the VIRAT dataset.</em></p>
...
<p align="center">
  <img src="results/Fig4.png" alt="Total processing time comparison" width="75%">
</p>
<p align="center"><em>Figure 4. Total processing time for 20 consecutive video frames under different interpolation proportions.</em></p>
...
<p align="center">
  <img src="results/Fig5.png" alt="Total transmission bits comparison" width="75%">
</p>
<p align="center"><em>Figure 5. Total transmission bits consumed for 20 consecutive video frames under different interpolation proportions.</em></p>
...
- Sample videos and simulation results can be found in the provided video file(s).
